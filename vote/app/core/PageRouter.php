...
class PageRouter extends Router {
    ...
    public function initRoutes() {
        ...
        $this->all('topvoters', function() {
            return $this->setRoute('index', 'topvoters');
        });
        ...
        $this->all('admin/voters/([0-9]+)', function($page) {
            return $this->setRoute('admin', 'voters', ['page' => $page]);
        });
        ...
        $this->all('admin/votes/([0-9]+)', function($page) {
            return $this->setRoute('admin', 'votes', ['page' => $page]);
        });

<?php
  ...
  // output data of each row
		while($row = $result->fetch_assoc()) {
			...
			echo "<li class='hiscores-list-item'><a href='https://dawnps.com/highscores/index.php?user=" . $row["username"] . "' class='hiscores-username'>".$mode." ".$rank." " . $row["username"] . "</a> <div>" . number_format($row["overall_xp"]) . "</div></li>";
		}
	} else {
